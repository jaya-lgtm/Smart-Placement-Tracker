    ...
    <div className="min-h-screen flex items-center justify-center bg-dark-950 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-2">Log in to manage your placement pipeline</p>
        </div>
        ...
        <div className="glass-card p-8 border border-dark-700 bg-dark-900/80 shadow-2xl">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-4 py-3 bg-dark-950 border border-dark-700 rounded-xl focus:border-brand-500 focus:ring-1 focus:ring-brand-500 focus:outline-none text-sm text-slate-100 placeholder-slate-500 transition-colors"
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-slate-400">
              New to the platform?{' '}
              <Link to="/register" className="text-brand-400 hover:text-brand-300 font-semibold inline-flex items-center">
                Create an account
